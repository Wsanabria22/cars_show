  ...
  return (
    ...
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={closeModal}>
        ...
        <div className='fixed inset-0 overflow-y-auto border-1 border-black-600'>
          <div className='flex min-h-full items-center justify-center p-4 text-center'>
            <Transition.Child 
              ...
              <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh]
                ...
                <button type='button' onClick={closeModal} className='absolute top-2 right-2
                  z-10 p-2 w-fit bg-primary-blue-100 rounded-full'>
                  <Image 
                    src={"/close.svg"}
                    alt='Close'
                    width={20}
